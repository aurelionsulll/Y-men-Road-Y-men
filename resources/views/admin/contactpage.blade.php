        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item"style="background-color: #e5e5e5"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('admincontact')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Message</span></a></li>
