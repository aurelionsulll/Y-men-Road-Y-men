    ...
    <aside class="left-sidebar" data-sidebarbg="skin6">
        <div class="scroll-sidebar" >
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li><br><br><br><br></li>
                    <li class="sidebar-item" style="background-color: #e5e5e5"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('cp_admin')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/infopage')}}" aria-expanded="false"><i class="mdi mdi-file-image"></i><span class="hide-menu">Info</span></a></li>
        ...
        <div class="page-wrapper" id="app">
            ...
            <footer class="footer text-center">
                All Rights Reserved by Ciprotec. Designed and Developed by <a href="https://ciprotec.ma">Ciprotec</a>.
            </footer>
        </div>
</div>
